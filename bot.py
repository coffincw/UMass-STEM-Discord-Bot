...
import asyncio
from overlay import overlay_image, url_to_image, get_image_url, draw_text, marius_origin, barr_origin, intensify_image
...
async def help():
    ...
    embed.add_field(
        name = 'Memes',
        value='*$mdraw [image/url]* - Sends a photo of <:smugmarius:557699496767651840> drawing on the specified image\n*$bdraw [image/url]* - Sends a photo of <:barr:561690828863438848> drawing on the specified image\n*barrify [image]* -  The bot uses computer vision through the OpenCV library to put <:barr:557186728167997445> on peoples faces in the inputed image\n*$erase* - Deletes the most recent m/bdraw or barrify generated by the bot',
        inline=True
    )
